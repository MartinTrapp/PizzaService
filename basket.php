...
//// START EXTRAS         
         ...
         $finalSum = korrektNachKomma($produkt["summe"]); 
//// START EDIT         
      ...
      $finalSum = korrektNachKomma($bestellsumme);
    }
    
    $_SESSION['bestellsumme'] = $finalSum;   // bestellsumme wird in der session gespeichert damit man sie der Order.php nicht ein weiteres mal berechnen muss
    echo '<tr>
